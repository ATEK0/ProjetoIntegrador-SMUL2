...
import pytest
from api.serializers import InterestSimulationSerializer, AmortizationSimulationSerializer
...
class TestInterestSerializer:
    ...
    def test_com_rate_tiers(self):
        data = {
            "principal": 10000, "rate": 0.03, "time": 4, "type": "compound",
            "rate_tiers": [
    ...
    def test_rate_opcional(self):
        ...
        data = {
            "principal": 10000, "time": 3, "type": "compound",
...
class TestAmortizationSerializer:
    ...
    def test_todas_periodicidades(self):
        for p in ["monthly", "quarterly", "semiannual", "annual"]:
            data = {
                "principal": 100000, "rate": 0.05, "years": 5,
                "periodicity": p, "commission": 0.0, "type": "french",
            }
            s = AmortizationSimulationSerializer(data=data)
    ...
    def test_periodicidade_invalida(self):
        data = {
            "principal": 100000, "rate": 0.05, "years": 5,
            "periodicity": "weekly", "commission": 0.0, "type": "french",
        }
        s = AmortizationSimulationSerializer(data=data)
        assert not s.is_valid()
    ...
    def test_principal_abaixo_minimo(self):
        data = {
            "principal": 0.0, "rate": 0.05, "years": 5,
            "periodicity": "monthly", "commission": 0.0, "type": "french",
        }
        s = AmortizationSimulationSerializer(data=data)
        assert not s.is_valid()
    ...
    def test_years_abaixo_minimo(self):
        data = {
            "principal": 100000, "rate": 0.05, "years": 0.0,
            "periodicity": "monthly", "commission": 0.0, "type": "french",
        }
        s = AmortizationSimulationSerializer(data=data)
        assert not s.is_valid()
    ...
    def test_comissao_negativa(self):
        data = {
            "principal": 100000, "rate": 0.05, "years": 5,
            "periodicity": "monthly", "commission": -10.0, "type": "french",
        }
        s = AmortizationSimulationSerializer(data=data)
        assert not s.is_valid()
