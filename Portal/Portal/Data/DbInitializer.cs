...
namespace Portal.Data
{
    public static class DbInitializer
    {
        public static void Initialize(ApplicationDbContext context)
        {
            ...
            {
                // Se a BD não estiver acessível, registamos o erro na consola para não bloquear o arranque da app
                Console.WriteLine($"[DbInitializer] Erro ao aplicar migrações ou semear dados: {ex.Message}");
            }
        }
    }
}
